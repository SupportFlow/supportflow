	...
	public function action_admin_enqueue_scripts() {
		...
		if ( in_array( $pagenow, array( 'post.php', 'post-new.php' ) ) ) {
			...
			wp_localize_script( $supportflow_tickets_handle, 'SFTickets', array(
				'no_title_msg'      => __( 'You must need to specify the subject of the ticket', 'supportflow' ),
				'no_respondent_msg' => __( 'You must need to add atleast one ticket respondent', 'supportflow' ),
			) );
		}
